...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "lxou_com888".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["iot.678rbt.com"];
pub const RS_PUB_KEY: &str = "7sOcAyqjfDCbM+fjKljYMCdR0fQH497pipkfqVnvMSU=";
